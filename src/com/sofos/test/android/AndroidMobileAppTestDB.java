...
public final class AndroidMobileAppTestDB extends com.sybase.persistence.Database
{
    ...
    private static com.sybase.persistence.ConnectionProfile _profile =
        new com.sybase.persistence.ConnectionProfile("androidMobileAppTest1_0");
    ...
    private static class AndroidMobileAppTestDBHolder {
       final static AndroidMobileAppTestDB instance = new AndroidMobileAppTestDB();
    }

    public static AndroidMobileAppTestDB getInstance() {
       return AndroidMobileAppTestDBHolder.instance;
    }
    ...
    private static com.sofos.test.android.intrnl.AndroidMobileAppTestDBMetaData META_DATA = new com.sofos.test.android.intrnl.AndroidMobileAppTestDBMetaData(DELEGATE);
    /**
    ...
    public static synchronized void initialize()
    {
        ...
        {
            _profile.setProperty("databaseFile", "androidMobileAppTest1_0.ulj");
            getConnectionProfile().setPageSize(1024);
        }
        ...
        _profile.getSyncProfile().setProperty("packageName","androidmobileapptest:1.0" );
        com.sybase.persistence.ConnectionProfile initProfile = new com.sybase.persistence.ConnectionProfile();
        initProfile.setServerName("SYBASE");
        ...
        DELEGATE.init("androidmobileapptest:1.0", "com.sofos.test.android", META_DATA, _profile, getDSI());
    }

    
    private AndroidMobileAppTestDB()
    {
        super(getMetaData());
    }
    ...
    {
        return "androidmobileapptest:1.0";
    }
    ...
    {
        return (com.sybase.collections.GenericList<com.sybase.persistence.LogRecord>)(Object)(com.sofos.test.android.LogRecordImpl.findWithQuery(query));
    }
     ...
     */
    public static synchronized com.sofos.test.android.PersonalizationParameters getPersonalizationParameters()
    {
        return (com.sofos.test.android.PersonalizationParameters) DELEGATE.getPersonalizationParameters();
    }
    /**
    ...
    {
        com.sofos.test.android.ChangeLogImpl.deleteChangeLogs();
    }
